...
# =========================================================
# AAA-inspired random shaping family (non-semantic only)
# =========================================================
ShapingType = Literal[
    "none",
    "linear",
...
def main():
    ...
    defense_list = [
        ...
        DefenseConfig(
            name="multiview_plus_top2_random_shaping",
            use_multiview=True,
            agg_type="avg_logits",
            use_random_shaping=True,
            shaping_family=("linear", "sine"),
        ...
        DefenseConfig(
            name="multiview_plus_top5_random_shaping",
            use_multiview=True,
            agg_type="avg_logits",
            use_random_shaping=True,
            shaping_family=("linear", "sine"),
